...
public class JwtUtils {
    ...
    // Gateway constructor — verify onl y
    ...
    public String generateAccessToken(String userId, String email, String role) {
        ...
        // jjwt 0.12.x API — fluent builder, no deprecated set* methods
        return Jwts.builder()
                .subject(userId)
                .claim("email", email)
                .claim("role", role)
                ...
                .signWith(privateKey)   // RS256 inferred from key type in 0.12.x
                .compact();
    }
    ...
    private Claims getClaims(String token) {
        // 0.12.x: parser() not parserBuilder(), verifyWith() not setSigningKey(),
